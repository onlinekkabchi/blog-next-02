...
export default async function Story({ index, order, title, content, tags }) {
  ...
  return (
    <Accordion>
      <AccordionSummary
        ...
        id={index}
      >
        <Typography marginY={1}>{title}</Typography>
      </AccordionSummary>
      <AccordionDetails>
    ...
    //         {title}
    //       </Typography>
    //       <TypoComponent variant="body2" color="#4f4f4f">
    //         {content}
    //       </TypoComponent>
    //     </Grid>
    //   </CardContent>
    //   <CardContent position="absolute" bottom="0">
    //     <Grid container justifyContent="flex-end">
    //       <svg
    //         onClick={() => sendMessage(title)}
    //         width="30"
